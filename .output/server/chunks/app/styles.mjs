...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.8c64ccbd.mjs').then(interopDefault),
  "pages/Home.vue": () => import('./_nuxt/Home-styles.4610b844.mjs').then(interopDefault),
